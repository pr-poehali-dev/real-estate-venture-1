    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-2xl font-heading font-bold text-slate-800">PrimeEstate</span>
            </div>
            <div className="hidden md:flex items-center gap-6">
              <button
                onClick={() => setActiveSection('home')}
                className={`font-medium transition-colors ${
                  activeSection === 'home' ? 'text-primary' : 'text-slate-600 hover:text-primary'
                }`}
              >
                Главная
              </button>
              <button
                ...
                className={`font-medium transition-colors ${
                  activeSection === 'catalog' ? 'text-primary' : 'text-slate-600 hover:text-primary'
                }`}
              >
                Каталог
              </button>
              <button
                ...
                className={`font-medium transition-colors ${
                  activeSection === 'new' ? 'text-primary' : 'text-slate-600 hover:text-primary'
                }`}
              >
                Новостройки
              </button>
              <button
                ...
                className={`font-medium transition-colors ${
                  activeSection === 'services' ? 'text-primary' : 'text-slate-600 hover:text-primary'
                }`}
              >
                Услуги
              </button>
              <button
                ...
                className={`font-medium transition-colors ${
                  activeSection === 'about' ? 'text-primary' : 'text-slate-600 hover:text-primary'
                }`}
              >
                О нас
              </button>
              <button
                ...
                className={`font-medium transition-colors ${
                  activeSection === 'contacts' ? 'text-primary' : 'text-slate-600 hover:text-primary'
                }`}
              >
                Контакты
              </button>
      ...
      {activeSection === 'home' && (
        <section className="relative h-[600px] flex items-center justify-center overflow-hidden">
          <div
            ...
            style={{
              backgroundImage: `url('https://cdn.poehali.dev/projects/c06123cb-de11-4378-852d-5693d39fec63/files/0c2b1951-acbf-4c7c-957f-fc019a941052.jpg')`
            }}
          >
      ...
      {activeSection === 'catalog' && (
        <section className="container mx-auto px-4 py-12">
          <h2 className="text-4xl font-heading font-bold text-slate-800 mb-8 animate-fade-in">
            Каталог недвижимости
          </h2>

          <Card className="mb-8 shadow-lg border-slate-200 animate-scale-in">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredProperties.map((property, index) => (
              <Card
                key={property.id}
                className="overflow-hidden hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 cursor-pointer border-slate-200 animate-slide-up"
          ...
          {filteredProperties.length === 0 && (
            <div className="text-center py-16 animate-fade-in">
              <Icon name="SearchX" size={64} className="mx-auto text-slate-300 mb-4" />
              <h3 className="text-xl font-heading font-semibold text-slate-600 mb-2">
                Ничего не найдено
              </h3>
      ...
      {activeSection === 'services' && (
        <section className="container mx-auto px-4 py-12">
          <h2 className="text-4xl font-heading font-bold text-slate-800 mb-8 text-center animate-fade-in">
            Наши услуги
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {[
              ...
              <Card
                key={index}
                className="text-center p-8 hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border-slate-200 animate-scale-in"
                style={{ animationDelay: `${index * 0.1}s` }}
              >
      ...
      {activeSection === 'about' && (
        <section className="container mx-auto px-4 py-12">
          <div className="max-w-4xl mx-auto animate-fade-in">
            <h2 className="text-4xl font-heading font-bold text-slate-800 mb-8 text-center">
              О компании
            </h2>
            <Card className="p-8 shadow-xl border-slate-200">
              ...
              <div className="grid grid-cols-3 gap-6 text-center pt-8 border-t border-slate-200">
                ...
                <div>
                  ...
                  <div className="text-slate-600">Успешных сделок</div>
                </div>
              </div>
            </Card>
          </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-slate-600">info@primeestate.ru</div>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <div className="font-semibold text-slate-800">Часы работы</div>
                      <div className="text-slate-600">Пн-Пт: 9:00 - 20:00<br />Сб-Вс: 10:00 - 18:00</div>
                    </div>
                  </div>
                </div>
              </Card>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-slate-400">
                ...
                <li><button onClick={() => setActiveSection('new')} className="hover:text-white transition-colors">Новостройки</button></li>
